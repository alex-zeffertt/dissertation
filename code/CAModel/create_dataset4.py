# Run ./model_complete.py with random different combination of inputs and build csv output and feedback terms
import numpy as np
from subprocess import check_output

csv_columns = [
    'mean_n_weak_ties','modal_weak_tie_km','awareness_pc','facility_pc','p_update_logit_normal_sigma','feedback',
...
while True:
    ...
    csv_output_line = [mean_n_weak_ties,modal_weak_tie_km,awareness_pc,facility_pc,p_update_logit_normal_sigma,feedback] + X + Y
